...
import { getOrSetCache, keyBuilders } from './cacheService.js';

const DASHBOARD_TTL_SECONDS = 60;

function readDashboardCache(organizationId, metric, loader) {
  const cacheKey = keyBuilders.dashboard(organizationId, metric);
  return getOrSetCache(cacheKey, loader, {
...
export const getMonthlyRevenue = async (organizationId) => {
  return readDashboardCache(organizationId, 'monthly-revenue', async () => {
    const Invoice = mongoose.model('Invoice');
...
export const getInvoiceStatusStats = async (organizationId) => {
  return readDashboardCache(organizationId, 'invoice-status', async () => {
    const Invoice = mongoose.model('Invoice');
...
export const getTopClientsByRevenue = async (organizationId) => {
  return readDashboardCache(organizationId, 'top-clients', async () => {
    const Invoice = mongoose.model('Invoice');
...
export const getRecentInvoices = async (organizationId) => {
  return readDashboardCache(organizationId, 'recent-invoices', async () => {
    const Invoice = mongoose.model('Invoice');
...
export const getMonthlyGrowth = async (organizationId) => {
  return readDashboardCache(organizationId, 'monthly-growth', async () => {
    const Client  = mongoose.model('Client');
    const Invoice = mongoose.model('Invoice');
...
export const getAverageInvoiceValue = async (organizationId) => {
  return readDashboardCache(organizationId, 'average-invoice-value', async () => {
    const Invoice = mongoose.model('Invoice');
...
export const getClientLifetimeValue = async (organizationId) => {
  return readDashboardCache(organizationId, 'client-lifetime-value', async () => {
    const Invoice = mongoose.model('Invoice');
...
export const getDashboardStats = async (organizationId) => {
  return readDashboardCache(organizationId, 'summary', async () => {
